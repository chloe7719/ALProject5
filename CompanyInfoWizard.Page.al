        ...
        area(content)
        {
            ...
            group(Step1)
            {
                ...
                group("Welcome to Company Info Wizard")
                {
                    ...
                    {
                        Caption = 'Step 1-1';
                        InstructionalText = 'Step1-1 - Replace this text with some instructions.';
                    }
                }
                group("Let's go!")
                {
                    ...
                    {
                        Caption = 'Step 1-2';
                        InstructionalText = 'Step1-2 - Replace this text with some more instructions.';
                    }
                }
            }
            ...
            group(Step3)
            {
                ...
                {
                    Caption = 'Step 3-1';
                    InstructionalText = 'Step 3-1 - Replace this text with some instructions.';
                }
                group("That's it!")
                {
                    Caption = 'That''s it!';
